...
public class BacklogController {
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask updateProjectTask, BindingResult result, @PathVariable String backlogId, @PathVariable String psId) {
